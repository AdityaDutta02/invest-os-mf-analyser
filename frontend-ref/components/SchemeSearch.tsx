...
export function SchemeSearch({
  ...
  const display = scheme && !open ? scheme.scheme_name : query;
  ...
  return (
    <div ref={wrapRef} className="relative flex-1 min-w-0" data-testid="scheme-search">
      ...
      {open && (
        <div className="absolute left-0 right-0 top-[calc(100%+4px)] z-40 bg-card border border-line-subtle rounded-sm overflow-hidden anim-fade-up" style={{ boxShadow: "var(--shadow-3)" }}>
